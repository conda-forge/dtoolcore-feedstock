About dtoolcore-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dtoolcore-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6459&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dtoolcore-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dtoolcore` can be installed with `conda`:
...
```
mamba install dtoolcore
```

It is possible to list all of the versions of `dtoolcore` available on your platform with `conda`:
...
```
mamba search dtoolcore --channel conda-forge
```
...
mamba repoquery search dtoolcore --channel conda-forge

# List packages depending on `dtoolcore`:
mamba repoquery whoneeds dtoolcore --channel conda-forge

# List dependencies of `dtoolcore`:
mamba repoquery depends dtoolcore --channel conda-forge
```
